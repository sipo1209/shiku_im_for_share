...
- (void)fetchMembersList1:(NSString*)roomName
{
	dispatch_block_t block = ^{ @autoreleasepool {
...
//        <iq id="Tq0Oq-4" type="get" from="taowencong@www.talk.com/Smack">
//        <query xmlns="jabber:iq:jixiong:RoomIQHandler" subdomain="conference" roomName="jxroom" action="memberList" />
//        </iq>
        
		
		NSXMLElement *query = [NSXMLElement elementWithName:@"query" xmlns:@"jabber:iq:jixiong:RoomIQHandler"];
        [query addAttributeWithName:@"subdomain" stringValue:@"conference"];
        [query addAttributeWithName:@"action" stringValue:@"memberList"];
        [query addAttributeWithName:@"roomName" stringValue:roomName];
		
		XMPPIQ *iq = [XMPPIQ iqWithType:@"get" to:roomJID elementID:fetchID child:query];
        NSString* myUserId = [[NSUserDefaults standardUserDefaults]objectForKey:kMY_USER_ID];
        NSString* jid = [NSString stringWithFormat:@"%@@%@",myUserId,kXMPP_Domain];
...
- (void)changeToMember:(NSString*)roomName nickName:(NSString*)nickName//成为会员
{
	dispatch_block_t block = ^{ @autoreleasepool {
...
//        <iq id="27AYY-4" type="set" from="taowencong@www.talk.com/Smack">
//        <query xmlns="jabber:iq:jixiong:RoomIQHandler" subdomain="conference" roomName="jxroom" action="memberAdd" nickname="taowencong" />
//        </iq>
        
		NSXMLElement *query = [NSXMLElement elementWithName:@"query" xmlns:@"jabber:iq:jixiong:RoomIQHandler"];
        [query addAttributeWithName:@"subdomain" stringValue:@"conference"];
        [query addAttributeWithName:@"action" stringValue:@"memberAdd"];
        [query addAttributeWithName:@"roomName" stringValue:roomName];
        [query addAttributeWithName:@"nickname" stringValue:nickName];
